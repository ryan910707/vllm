...
NUM_PROMPTS = 10
PROMPT_LENGTH =  1024  # target character length
OUTPUT_LEN = 16
BUFFER_SIZE = 160000*(160+1) # not used in cpu_push_mode
QPS = 12.0  # Queries per second (0 = no rate limiting, send as fast as possible)
